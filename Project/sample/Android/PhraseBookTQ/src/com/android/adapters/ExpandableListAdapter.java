...
public class ExpandableListAdapter extends BaseExpandableListAdapter {
	...
	public ExpandableListAdapter(Activity context, List<Phrase> laptops,
			Map<Phrase, List<Phrase>> laptopCollections,
	...
	public View getChildView(final int groupPosition, final int childPosition,
			...
			public void onClick(View v) {
				try {
					...
					List<Phrase> child = laptopCollections.get(laptops
							.get(groupPosition));
					Uri uri = Uri
							.parse("android.resource://com.example.phrasebooktq/raw/"
		...
		item.setText(laptop.getDescription3());
		item2.setText(laptop.getDescription4());
		String str = "I have learned phrase VietNamese\n" + "Phrase: "
				+ laptop.getPhrase() + "\nPronuciation: "
				+ laptop.getPronunciation() + "\nMean: " + laptop.getMean();
